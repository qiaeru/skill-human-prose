...
Le tic IA est l'enfilade qui relie des idées au lieu de construire une vraie subordination. Garde au plus un participe présent par phrase et, dès le deuxième, reconstruis la phrase par subordination ou par coordination équilibrée, sans prêter aux participes une cause que la source ne donne pas.
...
| --- | --- |
| « L'outil, permettant l'export des données et offrant un mode hors ligne, garantit la continuité du service. » | « L'outil exporte les données, fonctionne hors ligne et garantit la continuité du service. » |
| « Une solution s'appuyant sur A, mobilisant B et visant à C. » | « Une solution qui s'appuie sur A et mobilise B pour C. » |
| « Un outil visant à... » | « Un outil destiné à... » ou « Un outil conçu pour... » |

Surveille aussi le participe de profondeur, accroché à un fait simple pour l'enrichir (« peint en bleu et en or, reflétant l'attachement de la communauté à sa terre »). Garde le fait, et le participe seulement si la source soutient ce qu'il affirme, l'attribution à une source nommée ne suffisant pas.

## Adjectifs intensifs vides

Si l'adjectif peut sauter sans changer le sens, il saute.
...
Remplace le calque par le mot français. Isolé, l'anglicisme qui a son équivalent ne compte qu'en grappe, alors que le faux-ami de la section suivante est une faute dès la première occurrence.
...
| en termes de | pour, sur, en matière de |
...
L'IA donne à ces mots le sens du mot anglais qui leur ressemble.
...
| supporter | endurer, tolérer | _to support_ (= soutenir, prendre en charge une fonctionnalité) |
...
Ces ouvertures annoncent le propos au lieu de le tenir. Les annonces de franchise sont sous « Emphase performative ».
...
- « En tant que X, je », annonce de qualifications en tête d'une affirmation qui n'en dépend pas (« En tant que développeur, je peux vous dire que »), à distinguer du « en tant que » qui régit vraiment le propos (« En tant que président, il signe le décret »)
- « Fort de mes années d'expérience », même annonce sous une autre forme

## Connecteurs IA surutilisés

Aucun n'est interdit, et le français écrit articule volontiers par « toutefois » ou « cependant » en cours de phrase. Le tic est le connecteur servi en tête de chaque paragraphe, voire de chaque phrase (règle 9).
...
Aucun n'est interdit en soi, et « notamment » ou « précisément » gardent leurs emplois légitimes. Coupe l'adverbe qui n'ajoute rien au verbe qu'il modifie.
...
Nomme ce qui change au juste, ou signale à l'auteur que le texte ne le dit pas.
...
Donne le nombre ou la nature quand la source les fournit, et sinon retire le remplissage sans inventer ce qui manque.
...
Remplace-les par du français courant.
...
Une précaution isolée reste légitime lorsque l'incertitude est réelle. Le tic est l'empilement qui dilue l'affirmation (« il semblerait que cela pourrait, d'une certaine manière, contribuer à »), dont tu ne gardes que la précaution du doute réel.
...
Le paragraphe final qui récapitule ce que le lecteur vient de lire relève du même réflexe, avec ou sans étiquette. Coupe-le et termine sur le dernier point concret, l'enseignement ou la prochaine étape que le texte donne déjà.

## Emphase performative

Ces formules affichent une franchise que le propos ne montre pas.

- « soyons honnêtes », « soyons clairs »
- « disons-le clairement »
- « la vérité, c'est que »
- « disons-le franchement »
- « entre nous »
- « pour être tout à fait transparent », « pour être tout à fait honnête »
- « je vais être direct »
- « honnêtement » en tête de phrase
- « le truc, c'est que »

Coupe l'annonce et garde l'affirmation qu'elle précède.

## Fausses révélations

L'amorce pose l'auteur en seul initié devant un lecteur naïf, avant une affirmation ordinaire qui tient seule une fois l'amorce coupée.
...
Voir l'exemple 33 de [exemples.md](exemples.md).

## Commentaires interprétatifs

Le texte dit au lecteur quoi remarquer ou quel poids donner à ce qu'il lit, au lieu de le lui montrer par un fait. Si le point est clair, l'aparté tombe, et sinon le fait qui manque, pris dans le texte, le remplace.
...
Voir l'exemple 34 de [exemples.md](exemples.md).
...
Ces formules déguisent un point ordinaire en vérité cachée ou en maxime. Remplace-les par l'affirmation précise.
...
Un fait ordinaire devient un tournant, un héritage ou une promesse, par une locution, une section « Défis et perspectives » ou un paragraphe d'envoi. Garde le fait, coupe la portée et termine sur le dernier fait concret ou sur les projets que la source énonce.
...
Une autorité anonyme soutient une affirmation, ou une liste de médias soutient une personne, à la place de ce qui a été dit. Garde la source réelle et son propos quand le texte les nomme, et sinon coupe l'affirmation ou la liste, sans jamais inventer de source ni exiger une citation partout.
...
« Il est associé à la direction de X » cache s'il en est le président, un administrateur ou un consultant. Nomme le rapport que la source donne, et sinon garde le flou plutôt que d'inventer un rôle.
...
Le texte se lit comme une publicité, surtout pour un lieu, un produit ou une organisation. Dis ce que la chose est.
...
Chaque image éculée recouvre une phrase plate, qu'il faut écrire à sa place.
...
| un voyage, une aventure (au figuré, calque de _journey_) | processus, étapes, ou nomme-les |
| voyez cela comme (par réflexe) | décris la chose, garde l'analogie qui explique un mécanisme |

## Registre d'assistant

Quatre familles de résidus d'assistant, propres aux textes générés, se coupent sans rien retirer au propos.

**Flagornerie et accord réflexe.** Entre dans la réponse sans compliment ni approbation servie avant le moindre argument.
...
**Formules de service.** Garde la salutation utile et la courtoisie que le courriel professionnel français attend (« Je reste à votre disposition », « N'hésitez pas à me solliciter »), et coupe la formule calquée de l'anglais ou propre à l'assistant.
...
**Mentions résiduelles du modèle.** Supprime-les sans reformuler.
